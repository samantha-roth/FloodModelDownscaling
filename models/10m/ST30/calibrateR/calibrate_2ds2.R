...
if(dir.exists("/storage/work/svr5482/Reification/Philly/data/Norristown/nCh/calibration/10m/ST30")==F){
  dir.create("/storage/work/svr5482/Reification/Philly/data/Norristown/nCh/calibration/10m/ST30")}
...
#load("/storage/work/svr5482/FloodingModelCalibrationProject/multires/spatial/changPC2014/10m10m/outputData/nCh_RWE/100e400c/juST30m/cal/mcmc_res_homGP10.RData")
...
#setwd("/storage/work/svr5482/FloodingModelCalibrationProject/multires/spatial/changPC2014/10m10m/outputData/nCh_RWE/100e400c/juST30m/cal/.25/3cm")
